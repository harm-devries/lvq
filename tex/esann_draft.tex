...
\title{Deep Generalized Learning Vector Quantization}
...
\begin{abstract}
We propose an extension of Generalized Learning Vector Quantization, a popular prototype based classifier, in which distances are measured after a non-linear transformation parameterized by a deep neural network. 
\end{abstract}
